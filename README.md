...
ConfigAddNPCSpawnEntriesContainer=(NPCSpawnEntriesContainerClassString="SE_DinoSpawnEntriesOasis_C",NPCSpawnEntries=((AnEntryName="turkeys",EntryWeight=1.000000,NPCsToSpawnStrings=("0.25"))),NPCSpawnLimits=((NPCClassString="0.25",MaxPercentageOfDesiredNumToAllow=1.000000)))
